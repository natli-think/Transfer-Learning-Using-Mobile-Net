...
#Input the pre-trained model from keras
...
#Let's manipulate the Mobilenet architecture
#and retrain the top few layers and employ transfer learning.
...
#Lets now re-use MobileNet as it is quite lightweight (17Mb), 
#freeze the base layers and lets add and train the top few layers.
#Here only two classifiers, the blue tit, and the crow are trained.
...
#We ensure all the weights are non-trainable. We will only train the last few dense layers. 
